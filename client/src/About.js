...
function About() {
  return (
    <div class="grid h-screen place-items-center m-1">
        ...
        <h1 class="text-4xl font-bold mb-2">Hello and welcome to DEMO!</h1>
        <br></br>
        <h1 class="text-2xl font-bold mb-2">This web application allows you to record audio tracks, listen back to them, and share them publically... all from your web browser!</h1>
        <br></br>
        <div>
